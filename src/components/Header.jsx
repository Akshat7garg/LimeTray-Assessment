...
export const Header = () => {
  return (
    <header className='fixed z-10 top-0 left-0 w-full h-16.5 border-b-3 border-green-700 flex justify-between md:justify-around items-center px-5 bg-[#121212]'>
      <div className='flex items-center justify-center gap-1'>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 640"
          className='h-12.5 w-12.5 logo'
        >
        ...
        <span className='uppercase font-orbit letter-spacing-2 font-bold text-xl '>neotask</span>
      </div>
